  ...
  return (
    <div className="flex flex-col items-center relative group w-full max-w-md mx-auto">
      <div className="w-full">
        <img src={img} className="w-full object-cover" alt={title} />
      </div>
      ...
      <div className="absolute opacity-0 bg-[rgba(0,0,0,0.5)] group-hover:opacity-100 transition-all duration-500 ease-in-out w-full h-full top-0 left-0 flex items-center justify-center">
        <Link to={link}>
